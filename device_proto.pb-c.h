...
typedef struct DeviceRegisterRequest DeviceRegisterRequest;
typedef struct DeviceRegisterResponse DeviceRegisterResponse;
typedef struct DeviceLoginRequest DeviceLoginRequest;
typedef struct DeviceLoginResponse DeviceLoginResponse;
typedef struct DeviceLogUpdate DeviceLogUpdate;
typedef struct StateOnChangeDeviceMessage StateOnChangeDeviceMessage;
typedef struct DeviceUpdateConfigureRequest DeviceUpdateConfigureRequest;
typedef struct DeviceUpdateConfigureResponse DeviceUpdateConfigureResponse;
typedef struct DeviceUpdateScheduleRequest DeviceUpdateScheduleRequest;
typedef struct DeviceUpdateScheduleResponse DeviceUpdateScheduleResponse;
typedef struct DeviceAuthMessage DeviceAuthMessage;
typedef struct PingWebsocketDeviceRequest PingWebsocketDeviceRequest;
typedef struct PingWebsocketDeviceResponse PingWebsocketDeviceResponse;
typedef struct UpdateCoordinateDeviceRequest UpdateCoordinateDeviceRequest;
typedef struct UpdateCoordinateDeviceResponse UpdateCoordinateDeviceResponse;
typedef struct AnnounceErrorDeviceRequest AnnounceErrorDeviceRequest;
typedef struct UpdatePowerStateDeviceRequest UpdatePowerStateDeviceRequest;
typedef struct UpdateMeterDataDeviceRequest UpdateMeterDataDeviceRequest;
typedef struct UpdateModeDeviceRequest UpdateModeDeviceRequest;
typedef struct DeviceUpdateMessage DeviceUpdateMessage;
typedef struct RequireStreamDeviceRequest RequireStreamDeviceRequest;
typedef struct RequireStreamDeviceResponse RequireStreamDeviceResponse;
typedef struct ControlLaneDeviceRequest ControlLaneDeviceRequest;
typedef struct ControlLaneDeviceResponse ControlLaneDeviceResponse;
typedef struct SetActiveTimeDeviceRequest SetActiveTimeDeviceRequest;
typedef struct SetActiveTimeDeviceResponse SetActiveTimeDeviceResponse;
typedef struct SetCycleConfigDeviceRequest SetCycleConfigDeviceRequest;
typedef struct SyncTimeDeviceRequest SyncTimeDeviceRequest;
typedef struct SyncTimeDeviceResponse SyncTimeDeviceResponse;
typedef struct GetCoordinateDeviceRequest GetCoordinateDeviceRequest;
typedef struct GetCoordinateDeviceResponse GetCoordinateDeviceResponse;
typedef struct TriggerNotifyUserDeviceRequest TriggerNotifyUserDeviceRequest;
typedef struct TriggerNotifyUserDeviceResponse TriggerNotifyUserDeviceResponse;
typedef struct UpdateScheduleUserDeviceRequest UpdateScheduleUserDeviceRequest;
typedef struct UpdateScheduleUserDeviceResponse UpdateScheduleUserDeviceResponse;
typedef struct PowerControlUserRequest PowerControlUserRequest;
typedef struct SetDeviceActiveTimeUserRequest SetDeviceActiveTimeUserRequest;
typedef struct ForceOTAUpdateUserRequest ForceOTAUpdateUserRequest;
typedef struct ReleaseControlUserRequest ReleaseControlUserRequest;
typedef struct UserDeviceMessage UserDeviceMessage;
typedef struct DeviceMessage DeviceMessage;
...
struct  StateOnChangeDeviceMessage
{
  ProtobufCMessage base;
  char *deviceid;
...
struct  DeviceUpdateConfigureRequest
{
  ProtobufCMessage base;
  char *deviceid;
  /*
...
struct  DeviceUpdateConfigureResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  DeviceUpdateScheduleRequest
{
  ProtobufCMessage base;
  char *deviceid;
  /*
...
struct  DeviceUpdateScheduleResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  PingWebsocketDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
};
...
struct  PingWebsocketDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  UpdateCoordinateDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
  float lat;
...
struct  UpdateCoordinateDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  AnnounceErrorDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
  char *message;
...
struct  UpdatePowerStateDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
...
struct  UpdateMeterDataDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
  double v1;
...
struct  UpdateModeDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
...
struct  RequireStreamDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
...
struct  RequireStreamDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  ControlLaneDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
  uint32_t laneindex;
...
struct  ControlLaneDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  SetActiveTimeDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
...
struct  SetActiveTimeDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  SetCycleConfigDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
  uint32_t numphase;
...
struct  GetCoordinateDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
};
...
struct  GetCoordinateDeviceResponse
{
  ProtobufCMessage base;
  float lat;
  float log;
...
struct  TriggerNotifyUserDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
  char *phone;
...
struct  TriggerNotifyUserDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  UpdateScheduleUserDeviceRequest
{
  ProtobufCMessage base;
  char *deviceid;
...
struct  UpdateScheduleUserDeviceResponse
{
  ProtobufCMessage base;
  StatusCode *statuscode;
};
...
struct  PowerControlUserRequest
{
  ProtobufCMessage base;
  char *deviceid;
  protobuf_c_boolean ispoweron;
...
struct  SetDeviceActiveTimeUserRequest
{
  ProtobufCMessage base;
  char *deviceid;
  int32_t start_hour;
...
struct  ForceOTAUpdateUserRequest
{
  ProtobufCMessage base;
  char *deviceid;
};
...
struct  ReleaseControlUserRequest
{
  ProtobufCMessage base;
  char *deviceid;
};
