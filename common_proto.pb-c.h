...
typedef struct CPUParameter CPUParameter;
typedef struct CPUScheduler CPUScheduler;
typedef struct Device Device;
typedef struct SignParam SignParam;
typedef struct StationLaneLightConfig StationLaneLightConfig;
typedef struct MeterItem MeterItem;
typedef struct Station Station;
typedef struct Accessory Accessory;
typedef struct CardConfig CardConfig;
typedef struct MTFCPhaseGateConfig MTFCPhaseGateConfig;
typedef struct HMTime HMTime;
typedef struct ActiveLamp ActiveLamp;
typedef struct OneSideLampTime OneSideLampTime;
typedef struct OneCycleLampTime OneCycleLampTime;
typedef struct CycleLampForm CycleLampForm;
typedef struct OneTimeline OneTimeline;
typedef struct DayTimeLine DayTimeLine;
typedef struct TimeLampForm TimeLampForm;
typedef struct DayLampForm DayLampForm;
typedef struct LaneState LaneState;
